...
public record C2SKeysmashConfigSyncLetter(boolean useKeysmashing, String letterPoolOverride, float restockThreshold, float baseClarityChance, float startingClarityScore, float keysmashedMultiplier, float spokenLoudlyClarity, float nonletterClarity) implements CustomPayload {
	...
	public static final C2SKeysmashConfigSyncLetter DEFAULT = new C2SKeysmashConfigSyncLetter(true, "", 0.13f, 0.31f, 1f, 0.8f, 1.3f, 1f);
